...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DocumentSnapshot>(
      stream: FirebaseFirestore.instance.collection('userInfo').doc(FirebaseAuth.instance.currentUser!.uid).snapshots(),
              ...
              children: [
                Padding(
                  ...
                  child: EditableImage(
                    ...
                    widgetDefault: userRings(context, profilePicture: fetchProfilePicture(userData['profilePicture'], username, padding: true), experience: 2418),
